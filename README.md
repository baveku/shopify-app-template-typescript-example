# Shopify App Template - Node, Vue3, Typescript

This is a template for building a [Shopify app](https://shopify.dev/apps/getting-started) using Node and Vue3. It contains the basics for building a Shopify app.
...
- [Vue Router](https://router.vuejs.org/) is used for routing. We wrap this with file-based routing.
- [Vue Query](https://tanstack.com/query/v4/docs/adapters/vue-query) queries the Admin API.
